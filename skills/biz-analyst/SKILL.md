...
3. Check `.eve/attachments/` for files you can examine directly — especially process flows, data dictionaries, and requirements documents
4. Analyze from your business analysis perspective
